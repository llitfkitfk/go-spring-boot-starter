...
import (
	SpringCore "github.com/didi/go-spring/spring-core"
	SpringEcho "github.com/didi/go-spring/spring-echo"
	SpringBootWeb "github.com/go-spring/go-spring-boot-starter/spring-boot-web"
...
func init() {
	SpringBoot.RegisterModule(func(context SpringCore.SpringContext) {
		container := SpringEcho.NewGinContainer()
